...
import { AxisId, PolarAxisConfig, PolarAxisConfigInput } from '../../../../models/axis';
import { DatasetType } from '../../../../models/seriesType/config';

export function defaultizeAxis<TScale extends ScaleName = ScaleName>(
  inAxis: MakeOptional<PolarAxisConfigInput<TScale, any>, 'id'>[] | undefined,
  ...
  const inputAxes: MakeOptional<PolarAxisConfigInput<ScaleName, any>, 'id'>[] =
